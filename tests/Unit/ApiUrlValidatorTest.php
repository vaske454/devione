...
class ApiUrlValidatorTest extends TestCase
{
    ...
    /** @test */
    public function it_returns_400_for_empty_api_url()
    {
    ...
    /** @test */
    public function it_returns_400_for_incorrect_api_url()
    {
    ...
    /** @test */
    public function it_returns_400_for_api_url_not_matching_expected_url()
    {
    ...
    /** @test */
    public function it_returns_400_for_invalidly_formatted_api_url()
    {
